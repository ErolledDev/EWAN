/*
  ...
  2. Security
    ...
    - Add policies for authenticated users to:
      - View their own chat sessions and messages
      - Create new sessions and messages
      - Update their own sessions and messages
...
DROP INDEX IF EXISTS chat_sessions_visitor_id_idx;
DROP INDEX IF EXISTS chat_sessions_status_idx;
DROP INDEX IF EXISTS chat_messages_chat_session_id_idx;
